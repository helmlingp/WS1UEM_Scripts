<#
  .Synopsis
    This powershell script grants the "Log on as a Service" User Rights Assignment to the user specified by the $ServiceAccount param
    Created:   	    Nov, 2022
    Created by:	    Phil Helmling, @philhelmling
    Organization:   VMware, Inc.
    Filename:       GrantLogonasaService.ps1
    Github:         https://github.com/helmlingp/WS1UEM_Scripts
  .DESCRIPTION
    Grants the "Log on as a Service" User Rights Assignment to the user specified by the $ServiceAccount parameter.
    Can be deployed as a UEM Script or Application (Script inside ZIP). Ensure you enable the param section below if deploying as script within a ZIP
